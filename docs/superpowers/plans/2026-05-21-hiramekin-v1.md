...
- [ ] **Step 5: 既存ディレクトリへ Expo bare プロジェクトを初期化する**
...
- [ ] **Step 9: `app.json` にアイコン・スプラッシュ・通知権限を設定する**
...
- [ ] **Step 10: `native/` フォルダとスキーマファイルを作成する**
...
- [ ] **Step 1: 音声認識ライブラリが導入済みであることを確認する**
