...
- バージョン: `v1.0.1-beta`
- APK名: `hiramekin-v1.0.1-beta.apk`

## APK情報

- ローカル生成元: `android/app/build/outputs/apk/release/app-release.apk`
- ローカル配布ステージ: `artifacts/releases/hiramekin-v1.0.1-beta.apk`
...
```powershell
Copy-Item -LiteralPath android/app/build/outputs/apk/release/app-release.apk -Destination artifacts/releases/hiramekin-v1.0.1-beta.apk -Force
Get-FileHash artifacts/releases/hiramekin-v1.0.1-beta.apk -Algorithm SHA256
```

3. GitHub Releases に `v1.0.1-beta` を作成し、APKをアップロードする。
4. `https://github.com/pakpadev/hiramekin/releases/download/v1.0.1-beta/hiramekin-v1.0.1-beta.apk` が直接ダウンロードできることを確認する。
